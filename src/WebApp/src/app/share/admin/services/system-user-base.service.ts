...
import { RegisterDto } from '../models/system-user/register-dto.model';
import { SystemUserUpdateDto } from '../models/system-user/system-user-update-dto.model';
import { LoginDto } from '../models/system-user/login-dto.model';
import { SystemUser } from '../models/system-user/system-user.model';
import { LoginResult } from '../models/system-user/login-result.model';
...
export class SystemUserBaseService extends BaseService {
   ...
   */
  update(data: SystemUserUpdateDto): Observable<SystemUser> {
    const _url = `/api/admin/SystemUser`;
    return this.request<SystemUser>('put', _url, data);
  }
