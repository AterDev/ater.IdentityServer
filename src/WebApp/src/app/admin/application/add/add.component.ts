...
export class AddComponent implements OnInit {
  ...
  initForm(): void {
    this.formGroup = new FormGroup({
      applicationType: new FormControl(null, [Validators.maxLength(0)]),
      clientId: new FormControl(null, [Validators.required,Validators.maxLength(100)]),
      clientSecret: new FormControl(null, [Validators.maxLength(120)]),
      clientType: new FormControl(null, [Validators.maxLength(0)]),
      consentType: new FormControl(null, [Validators.maxLength(0)]),
      displayName: new FormControl(null, [Validators.required,Validators.maxLength(100)]),
      permissions: new FormControl(null, [Validators.maxLength(0)]),
      postLogoutRedirectUris: new FormControl(null, [Validators.maxLength(0)]),
      properties: new FormControl(null, [Validators.maxLength(0)]),
      redirectUris: new FormControl(null, [Validators.maxLength(0)]),
      requirements: new FormControl(null, [Validators.maxLength(0)]),
      settings: new FormControl(null, [Validators.maxLength(0)]),
  ...
  add(): void {
    ...
    const data = this.formGroup.value as ApplicationAddDto;
